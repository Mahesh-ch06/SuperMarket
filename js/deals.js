// Deals page specific JavaScript
...
function addToCart(product) {
    ...
    window.FreshMartCommon.showToast(`${product.name} added to cart!`, 'success');
}
...
function initializeDealsPage() {
    ...
    window.FreshMartCommon.showToast('Welcome to FreshMart Deals! 🔥', 'success', 3000);
}
