...
signupFormElement.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        showToast('Account created successfully! Please check your email to verify your account.', 'success', 6000);
...
document.addEventListener('DOMContentLoaded', () => {
    showToast('Welcome to FreshMart! Please sign in to continue.', 'info', 3000);
});